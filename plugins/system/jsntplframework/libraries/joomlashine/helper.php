...
abstract class JSNTplHelper
{
	...
	/**
	 * Delete Orphan Megamenu Items
	 *
	 * @return boolean	True on delete successfully, vice versa
	 */
	...
	/**
	 * Get megamenu item list by style id
	 *
	 * @param int $styleID
	 * @return ArrayObject of megamenu items
	 */
	public static function getMegamenuItemListByStyleID($styleID)
	{
		$megamenuTableIsExisted = JSNTplHelper::checkMegamenuTable();

		if (!$megamenuTableIsExisted)
		{
			return array();
		}
